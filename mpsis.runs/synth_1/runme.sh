...
HD_PWD='/home/pin_34_11/mpsis_semester6/mpsis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder32.tcl
